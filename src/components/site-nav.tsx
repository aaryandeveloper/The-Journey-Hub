...
export function SiteNav() {
  const neuro = conditions.filter((c) => c.category === "neurological").slice(0, 4);
  const ortho = conditions.filter((c) => c.category === "orthopedic").slice(0, 4);
      ...
      <div className="mx-auto flex h-24 max-w-7xl items-center gap-10 px-6">
        ...
        <div className="ml-auto flex items-center gap-10">
          <div className="hidden gap-8 text-sm font-medium tracking-tight md:flex">
            ...
            <Link to="/about/practice" className="transition-colors hover:text-primary">About Us</Link>
            <Link to="/about/team" className="transition-colors hover:text-primary">Team</Link>
            ...
            <div className="group relative">
              ...
              <div className="pointer-events-none absolute -left-4 top-full w-[520px] translate-y-2 rounded-xl border border-border bg-card p-6 opacity-0 shadow-2xl transition-all duration-200 group-hover:pointer-events-auto group-hover:translate-y-0 group-hover:opacity-100">
